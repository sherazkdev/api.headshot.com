...
echo "   FIREBASE_PROJECT_ID, FIREBASE_CLIENT_EMAIL, FIREBASE_PRIVATE_KEY, JWT_SECRET, GEMINI_API_KEY"
echo ""
echo "2. npm run seed && npm run index"
echo "3. nginx mein include line add karo (render-config output dekho)"
echo "   nginx -t && nginx -s reload"
echo ""
echo "4. bash deploy/pm2-setup.sh   (ya: pm2 start deploy/ecosystem.config.cjs)"
echo "5. curl http://127.0.0.1:3016/v1/health"
